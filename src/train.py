...
def train(n_samples: int, max_depth: int, n_estimators: int) -> None:
    ...
    with mlflow.start_run():
        ...
        # Register this run's model as a new version in the registry. Promotion
        # to a stage (Staging / Production) is a separate, deliberate step
        # handled by src/registry.py.
